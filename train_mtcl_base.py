        ...
        for i, (inputs, labels) in enumerate(self.loader_dict['train']):
            ...
            progress_bar(i, len(self.loader_dict['train']),
                         ...
                         % (train_loss / (i + 1), 100. * correct / total, correct, total,
                            ...
                            self.loss_ensemble['dist_loss'], self.loss_ensemble['pd_loss'],
...
def main():
    ...
    parser.add_argument('--config', type=str, help='config file path',
                        default='/summer/WaveSleepNet/configs/SleePyCo-Transformer_SL-10_numScales-3_Sleep-EDF-2018_wavesensing.json')
